...
<div class="container-fluid">
    ...
    <div class="col-md-12">
        <div class="card">
                            {{-- <div class="card-body"> --}}
                                <h4 class="card-title text-center p-2 bg-success">Add Offer Product</h4>


                                <form class="form-horizontal" action="{{ route('save-product-offer') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            <lebel class="col-sm-3 text-right control-lebel col-form-lebel">Product Main Price</lebel>
                                            <div class="col-sm-7" >
                                                <input type="integer" name="product_price" class="form-control"  placeholder="Enter Product Main Price">
                                                <span class="text-danger"> {{$errors->has('product_price') ? $errors->first('product_price'):''}} </span>
                                            </div>
                                        </div>

                                        <div class="form-group row">
                                            <lebel class="col-sm-3 text-right control-lebel col-form-lebel">Product Offer Price</lebel>
                                            <div class="col-sm-7" >
                                                <input type="integer" name="product_offer_price" class="form-control"  placeholder="Enter Product offer Price">
                                                <span class="text-danger"> {{$errors->has('product_offer_price') ? $errors->first('product_offer_price'):''}} </span>
                                            </div>
                                        </div>
                                    </div>
