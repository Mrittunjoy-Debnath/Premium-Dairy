        ...
        <ul class="navbar-nav float-end">
          ...
          <li class="nav-item dropdown">
            ...
            >
              ...
              <div class="dropdown-divider"></div>
              <a class="dropdown-item bg-danger" href="javascript:void(0)"
              href="{{ route('home') }}" onclick="event.preventDefault();
              document.getElementById('logout-form').submit();"
                ><i class="fa fa-eye me-1 ms-1 "></i> User View</a
              >
              ...
              <div class="ps-4 p-10">
                <a
                  href="{{ route('home') }}"
                  class="btn btn-sm btn-success btn-rounded text-white btn-lg"
                  >User View</a
                >
              </div> --}}
