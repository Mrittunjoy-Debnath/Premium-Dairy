...
<div class="container-fluid" >
    <div class="row">
        ...
        <h3 class="mx-2 p-1 text-center text-white bg-success fw-bold">Premium Offer Products</h3>
        </div>
        <hr>
        @php($i=1)
        ...
        <div class="col-md-4">
            ...
            <form action="{{route('add-offer-cart',$product->id)}}" method="post">
            @csrf
            ...
            <div class="card mx-2 mt-3" >
                ...
                <p class="card-text"><span class="text-decoration-line-through">{{ $product->product_price }} TK. </span><span class="mx-4"> {{ $product->product_offer_price }}TK.</span></p>
